  ...
  const tabs = [
    {
      ...
      content: (
        <div className="space-y-2.5">
          {[
            "Theory sessions to refine compass techniques, natural underwater references and dive site mapping",
            ...
            "SSI Underwater Navigation Certification",
            "Dive insurance",
          ].map((item, i) => (
    ...
    },
    {
      ...
      content: (
        <div className="space-y-2 text-sm text-[#0A1628]/60 leading-relaxed">
          <p>Start the day at 9am with interactive theory sessions focused on underwater navigation, dive site mapping, and route planning. You&apos;ll then move into hands-on practice, refining compass use and natural navigation techniques.</p>
          <p>The course finishes with two training dives, where you&apos;ll apply everything you&apos;ve learned while navigating Koh Tao&apos;s top dive sites.</p>
        </div>
      ),
    },
  ]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            <div>
              ...
              <div className="flex items-center gap-3 md:gap-6 mb-5 flex-wrap">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-sm md:text-base font-bold text-[#F8B85D]" style={{ fontFamily: 'var(--font-space-mono)' }}>6,000 THB</span>
                </div>
              </div>

              <p className="text-sm md:text-base text-[#0A1628]/60 leading-relaxed">
                Knowing where you are — and where you&apos;re going — transforms the way you dive. Our one-day Navigation Specialty is a focused, hands-on course that includes two training dives, designed to help you truly understand the underwater environment. You&apos;ll learn how to combine natural navigation with precise compass skills, plan routes, maintain orientation, and return confidently to your exit point.
              </p>

              <div className="mt-6">
                <a
                  href="https://wa.me/66971543171?text=Hi!%20I%27m%20interested%20in%20the%20Navigation%20course%20%F0%9F%A4%BF"
                  target="_blank"
            ...
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden">
              <Image
                ...
                alt="Navigation Course in Koh Tao"
                fill
      ...
      <section className="py-10 md:py-16">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-sm text-[#0A1628]/60 leading-relaxed mb-6">
            Move through the ocean with clarity, control, and flow.
          </p>
