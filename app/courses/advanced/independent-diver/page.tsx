...
export default function IndependentDiverPage() {
  ...
  const tabs = [
    {
      ...
      content: (
        <div className="space-y-2.5">
          {[
            "In-depth theory sessions covering dive planning, risk assessment, gas management, self-reliant skills, equipment considerations, and emergency procedures",
      ...
      content: (
        <div className="space-y-3 text-sm text-[#0A1628]/60 leading-relaxed">
          <div>
            ...
            <p>Morning academic sessions begin at 9:00am, covering essential topics such as gas management, dive planning, partial pressure and gas effects, emergency procedures, and more. In the afternoon, we head out on the boat to complete a confined water session focused on emergency skills, followed by an open water dive.</p>
          </div>
          <div>
            <p className="font-bold text-[#0A1628] mb-1">Day 2</p>
            <p>We kick off the day with theory about how to manage potential challenges during independent dives. We continue with 2 more open water dives where you&apos;ll apply everything you&apos;ve learned in real diving conditions.</p>
          </div>
        </div>
      ),
    },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            <div>
              ...
              <div className="flex items-center gap-3 md:gap-6 mb-5 flex-wrap">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-sm md:text-base font-bold text-[#0A1628]" style={{ fontFamily: 'var(--font-space-mono)' }}>2 Days</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <svg className="h-5 w-5 md:h-6 md:w-6 text-[#4D9995]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-sm md:text-base font-bold text-[#F8B85D]" style={{ fontFamily: 'var(--font-space-mono)' }}>12,000 THB</span>
                </div>
              </div>

              <p className="text-sm md:text-base text-[#0A1628]/60 leading-relaxed">
                The SSI Independent Diver course is designed for experienced divers who want to explore top dive sites independently while maintaining the highest safety standards. Independent diving allows you to move at your own pace, plan dives your way, and make decisions confidently underwater. Over two focused days and four open water dives, you&apos;ll master self-reliance, redundant systems, advanced dive planning, and emergency procedures.
              </p>

              <div className="mt-6">
                <a
                  href="https://wa.me/66971543171?text=Hi!%20I%27m%20interested%20in%20the%20Independent%20Diver%20course%20%F0%9F%A4%BF"
                  target="_blank"
            ...
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden">
              <Image
                ...
                alt="Independent Diver Course in Koh Tao"
                fill
      ...
      <section className="py-10 md:py-16">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-sm text-[#0A1628]/60 leading-relaxed mb-6">
            Complete freedom beneath the surface — safely and confidently.
          </p>
