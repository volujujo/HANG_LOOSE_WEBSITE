...
const trips = [
  {
    ...
    dives: '20+ Dives',
    price: 'From €1,500',
    description: "Explore Egypt's legendary shipwrecks along the North Route of the Red Sea. Crystal-clear waters, vibrant coral reefs, iconic wrecks, and good vibes all week long.",
  },
  {
    title: 'The Maldives',
