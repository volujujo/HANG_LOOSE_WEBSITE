  ...
  const tabs = [
    {
      ...
      content: (
        <div className="space-y-2.5">
          {[
            "Theory sessions covering the fundamentals of night diving, including dive planning, navigation, low-light communication, and proper torch use",
            "2 Night Dives",
            ...
            "SSI Night and Limited Visibility Certification",
            "Dive insurance",
          ].map((item, i) => (
      ...
      content: (
        <div className="space-y-3 text-sm text-[#0A1628]/60 leading-relaxed">
          <div>
            ...
            <p>Begin with theory sessions covering night diving procedures and planning, equipment use, and safety considerations. The evening continues with a guided night dive, where you&apos;ll apply what you&apos;ve learned while exploring Koh Tao&apos;s best dive sites at night.</p>
          </div>
          <div>
            <p className="font-bold text-[#0A1628] mb-1">Day 2</p>
            <p>Head out for a second guided night dive, building on your skills and confidence as you further experience the underwater world after dark.</p>
          </div>
        </div>
      ),
    },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            <div>
              ...
              <div className="flex items-center gap-3 md:gap-6 mb-5 flex-wrap">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-sm md:text-base font-bold text-[#F8B85D]" style={{ fontFamily: 'var(--font-space-mono)' }}>6,500 THB</span>
                </div>
              </div>

              <p className="text-sm md:text-base text-[#0A1628]/60 leading-relaxed">
                The Night and Limited Visibility Specialty opens the door to a completely different side of the underwater world. Designed to build confidence and control in low-light conditions, this course teaches you how to dive safely, stay oriented, and remain comfortable when visibility is reduced — turning darkness into an exciting new environment rather than a challenge.
              </p>

              <div className="mt-6">
                <a
                  href="https://wa.me/66971543171?text=Hi!%20I%27m%20interested%20in%20the%20Night%20Diving%20course%20%F0%9F%A4%BF"
                  target="_blank"
            ...
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden">
              <Image
                ...
                alt="Night Diving Course in Koh Tao"
                fill
      ...
      <section className="py-10 md:py-16">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="text-xl md:text-3xl font-black uppercase text-[#0A1628] mb-3" style={{ fontFamily: 'var(--font-space-mono)', lineHeight: 1.1 }}>
            See What the Reef Hides After Dark
          </h2>
          <p className="text-sm text-[#0A1628]/60 leading-relaxed mb-6">
            The ocean at night is a world like no other.
          </p>
