        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            <div>
              ...
              <div className="flex items-center gap-3 md:gap-6 mb-5 flex-wrap">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-sm md:text-base font-bold text-[#0A1628]/60" style={{ fontFamily: 'var(--font-space-mono)' }}>19,900 THB</span>
                </div>
              </div>
            ...
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden">
              <Image
                src="/gallery/inforecreationalsidemount.webp"
