      ...
      <section className="py-6 md:py-8 px-6 md:px-12 lg:px-20">
          ...
          <div className="flex gap-3">
            ...
            <div className="flex flex-col gap-3 flex-1">
              <div className="relative overflow-hidden rounded-2xl aspect-[4/3]">
                <Image src="/gallery/photo3.webp" alt="Maldives diving" fill className="object-cover" sizes="50vw" />
              </div>
              <div className="relative overflow-hidden rounded-2xl aspect-[4/3]">
                <Image src="/gallery/photo4.webp" alt="Maldives ocean" fill className="object-cover" sizes="50vw" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="hidden md:flex gap-4 h-[360px] lg:h-[430px]">
          <div className="relative overflow-hidden rounded-2xl flex-[1.1] min-w-0">
            <Image src="/gallery/photo1.webp" alt="Maldives liveaboard" fill className="object-cover" sizes="50vw" />
          </div>
          ...
          <div className="flex flex-col gap-4 flex-[0.45] min-w-0">
            <div className="relative overflow-hidden rounded-2xl flex-1">
              <Image src="/gallery/photo3.webp" alt="Maldives diving" fill className="object-cover" sizes="25vw" />
            </div>
            <div className="relative overflow-hidden rounded-2xl flex-1">
              <Image src="/gallery/photo4.webp" alt="Maldives ocean" fill className="object-cover" sizes="25vw" />
            </div>
          </div>
        </div>
      </section>
